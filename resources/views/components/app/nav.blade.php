        ...
        <div class="flex flex-col md:items-center md:flex-row">
            ...
            <div class="flex justify-center -mt-3 grow mb-1 px-2 md:mt-1">
                <input type="text" placeholder=""
                    class="px-2 rounded-lg text-sm border-white text-slate-500 h-[32px] w-[230px] md:w-[400px] lg:w-[600px] object-cover mx-2">
                        ...
                        <div class="flex flex-row md:flex-col-reverse gap-2 justify-between mb-1 mt-2">
                            <div class=" md:invisible">
                                <p class="text-sm">Halo, kak <span
                                        class="font-semibold hover:text-blue-300 transition delay-50 duration-300 ease-in-out "><a
                                            href="">{{ Auth::user()->nickname }}</a></span></p>
                            </div>
                            <div class="flex justify-center gap-6">
                                <a class="text-lg fa fa-bucket"></a>
                                <a class="text-lg fa fa-user"></a>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf

                                    <a href="{{ route('logout') }}" class=" text-lg fa fa-right-from-bracket" onclick="event.preventDefault();
