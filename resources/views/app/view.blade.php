...
<div class="flex justify-center">
    <div class="mx-auto my-auto mt-28 md:mt-20 lg:mt-24">
        <div class="flex justify-between px-2 py-1">
            <a href="{{ url()->previous() }}"><span class="fa fa-arrow-left"></span></a>
            <a href="{{route('app')}}"><span class="fa fa-home"></span></a>
        </div>
        <div class="rounded-lg shadow-lg px-4 py-4 bg-white">
            <div
                ...
                <div class="flex flex-col-reverse lg:flex-row">
                    <div class="flex flex-col w-[280px] mt-4 md:mt-0 text-clip">
                        <p>Deskripsi Barang :</p>
                        <p>{{$product->description}}</p>
                    </div>
                    <div class="flex flex-col w-[280px] justify-start md:my-0 mb-2 ml-0 md:ml-4">
            ...
            <div>
                ...
                <div class="flex flex-wrap gap-2 lg:gap-4 mt-4 justify-center">
                    ...
                    <a href="{{route('show', ['category' => $product->category, 'name' => $product->name])}}" class="w-24 h-24 md:w-24 md:h-24 lg:w-32 lg:h-32">
                        <img src="{{ asset('storage/ProductCoverImages/' . $product->cover) }}" class="rounded-md" alt="">
                    </a>
                    @endforeach --}}
                </div>
            </div>
